...
import { PurchaseCreateNestedManyWithoutLaptopsInput } from "../inputs/PurchaseCreateNestedManyWithoutLaptopsInput";
import { OS } from "../../enums/OS";

@TypeGraphQL.InputType("LaptopCreateWithoutCommentsInput", {
  isAbstract: true
})
export class LaptopCreateWithoutCommentsInput {
  ...
  @TypeGraphQL.Field(_type => PurchaseCreateNestedManyWithoutLaptopsInput, {
    nullable: true
  })
  purchases?: PurchaseCreateNestedManyWithoutLaptopsInput | undefined;
