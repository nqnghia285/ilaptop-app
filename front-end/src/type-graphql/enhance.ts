...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "profile", "password", "role", "posts", "createdAt", "updatedAt"],
  UserOrderByWithRelationInput: ["id", "profile", "password", "role", "posts", "createdAt", "updatedAt"],
  ...
  UserCreateInput: ["password", "role", "createdAt", "updatedAt", "profile", "posts"],
  UserUpdateInput: ["password", "role", "createdAt", "updatedAt", "profile", "posts"],
  ...
  UserCreateWithoutProfileInput: ["password", "role", "createdAt", "updatedAt", "posts"],
  ...
  UserUpdateWithoutProfileInput: ["password", "role", "createdAt", "updatedAt", "posts"],
  ...
  UserCreateWithoutPostsInput: ["password", "role", "createdAt", "updatedAt", "profile"],
  ...
  UserUpdateWithoutPostsInput: ["password", "role", "createdAt", "updatedAt", "profile"],
